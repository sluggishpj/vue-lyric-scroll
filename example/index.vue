<template>
    <div id="app">
        <div class="lyric">
            <LyricScroll :lyric="lyric" :t-lyric="tLyric" :lyric-active-class="'lyric-active'" :lyric-center-class="'lyric-center'" :current-time="currentTime" @change-current-time="changeCurrentTime" />
        </div>
    </div>
</template>

<script>
const LyricScroll = () => import('../src/lyric-scroll.vue')
// const LyricScroll = () => import('../dist/lyric-scroll.esm.js')
export default {
    name: 'app',
    components: {
        LyricScroll
